    ...
    i chcesz zachować jej ciągłość.
        ...
        <div className="grid md:grid-cols-3 gap-4">
          ...
          <div className="rounded-2xl border border-yellow-500/20 bg-yellow-500/10 p-6 relative overflow-hidden">
            ...
            <div className="mt-6 text-2xl font-semibold text-white">
              {formatPrice(49)}
              <span className="text-sm text-white/60 font-normal"> / jednorazowo</span>
            </div>
          ...
          <div className="rounded-2xl border border-yellow-500/30 bg-yellow-500/15 p-6 relative overflow-hidden">
            ...
            <ul className="mt-6 text-sm text-white/85 space-y-2">
              ...
              <li>
                🚀 Limity miesięczne:{" "}
                <span className="text-white/90 font-medium">
                  {proPlus.monthlyPdf} PDF + {proPlus.monthlyImages} obrazów
                </span>
              </li>
              <li>
                🚀 Większy limit wiadomości dziennie:{" "}
                <span className="text-white/90 font-medium">
                  {proPlus.dailyMessages} / dzień
                </span>
              </li>
        ...
        <div className="mt-12 rounded-2xl border border-white/10 bg-white/5 p-6">
          <h2 className="text-white font-semibold text-lg">Dlaczego PRO ma sens?</h2>
          <div className="mt-3 text-white/70 text-sm leading-relaxed">
            Bo rozmowy, które naprawdę pomagają, potrzebują ciągłości.
            PRO i PRO+ pozwalają wracać do tego, co ważne, bez utraty kontekstu
            i bez przerywania w najważniejszym momencie.
          </div>
